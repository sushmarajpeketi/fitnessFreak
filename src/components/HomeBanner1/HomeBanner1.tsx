...
//   const simplifiedDeniminator = denominator/commonDivisor
//   return [simplifiedNumerator,simplifiedDeniminator]
// }
//   // return (
...
//   //         size="lg"
//   //         variant="solid">
//   //           {simpleFraction(item.value,item.goal)[0] + '/' + simpleFraction(item.value,item.target)[1]}
//   //         </CircularProgress>
